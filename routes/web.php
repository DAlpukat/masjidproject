...
Route::middleware(['auth', 'admin'])
    ...
    ->group(function () {
        ...
        // Rute 'Kick Member' (Diambil dari file pertama dan disesuaikan struktur prefix-nya)
        Route::delete('/tempat/{id}/members/{userId}', [TempatLayananController::class, 'kick'])->name('members.kick');
