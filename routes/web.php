...
// --- 4. Halaman Admin (Hanya Admin Pembuat Kelas) ---
...
// --- 6. Redirect Standar Laravel Breeze ---
Route::get('/dashboard', function () {
    return redirect()->route('home');
})->middleware(['auth'])->name('dashboard');

// --- 7. Route Khusus Superadmin (Approve Kelas, Hapus Global) ---
