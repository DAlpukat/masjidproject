                            ...
                            <tr class="hover:bg-white/50 transition-all duration-300 group">
                                ...
                                <td class="px-8 py-6 text-center">
                                    <div class="flex items-center justify-center space-x-3">
                                        ...
                                        <!-- Tombol Anggota-->
                                         <a href="{{ route('admin.group.members', $item->id) }}" class="p-2 bg-emerald-50 text-emerald-600 rounded-xl hover:bg-emerald-600 hover:text-white transition-all shadow-sm" title="Lihat Anggota Grup">
                                        ...
                                        <!-- Tombol Pages -->
                                        <a href="{{ route('admin.pages.index', $item->id) }}" class="p-2 bg-purple-50 text-purple-600 rounded-xl hover:bg-purple-600 hover:text-white transition-all shadow-sm">
